...
export const taxonomy: TaxonomyCategory[] = [
  {
    ...
    summary:
      "Help users identify and validate what they’re experiencing. Not a diagnostic site, but an educational resource.",
    intro:
      "Before anything can be fixed, it has to be named. This section is a map of the territory you already recognize, written so you can stop wondering whether you are broken.",
    topics: [
      {
        slug: "brain-fog",
        title: "Brain Fog & Cognitive Overload",
        feels:
          "The world is wrapped in cotton. Thoughts move slowly, words do not come, simple mental arithmetic feels like lifting something heavy. You reread the same paragraph. You forget why you walked into the room.",
        why: [
      ...
      },
      {
        ...
        title: "Burnout",
        feels:
          "Exhaustion, cynicism, reduced efficacy. Running on empty, numbness, detachment from who you used to be. Small decisions feel impossible.",
        why: [
      ...
      },
      {
        ...
        feels:
          "Re-experiencing events (flashbacks), hyperarousal, avoidance, numbness. The body keeps answering a threat that has passed. Or quieter fractures: growing up too fast, emotional neglect, betrayal, displacement, spiritual wounding — experiences that never got a name until now.",
        why: [
      ...
      },
      {
        ...
        title: "Anxiety & Panic",
        feels:
          "Heart racing, sweating, racing thoughts, a sense of impending doom. Hypervigilance from stress can mimic anxiety.",
        why: ["Overactive fight-or-flight response.", "Excessive focus on future 'what-ifs'."],
        steps: [
  ...
  },
  {
    ...
    intro:
      "This is the unglamorous foundation. Every cognitive technique fails on a body that has not slept, has not eaten, and has not moved.",
    topics: [
      {
        slug: "sleep",
  ...
  },
  {
    ...
    intro:
      "A foggy mind cannot supply motivation. The routine has to be small enough to run without any willpower. Focus on time-of-day structures.",
    topics: [
      {
        slug: "morning",
        title: "Morning Routine",
        why: ["Sets the circadian rhythm and tone for the day."],
        steps: [
  ...
  },
  {
    ...
    intro:
      "Emotions are signals, not enemies. Is it OK to feel this way? Yes. Here are healthy ways to respond.",
    topics: [
      {
        slug: "sadness",
        title: "Sadness & Grief",
        ...
        whenToSeekHelp: ["If grief is prolonged, intense, or accompanied by suicidal thoughts."],
        islamicView: [
  ...
  },
  {
    ...
    summary:
      "Integrate Islamic spirituality into your recovery journey for meaning and resilience.",
    intro:
      "Faith is woven throughout recovery. Believers are tested, but solace is found through worship. Here we explore how Islamic practices complement evidence-based mental health care.",
    topics: [
      {
